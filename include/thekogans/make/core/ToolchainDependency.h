...
#if !defined (__thekogans_make_core_ToolchainDependency_h)
#define __thekogans_make_core_ToolchainDependency_h
...
#endif // !defined (__thekogans_make_core_ToolchainDependency_h)
